 ...
 */
View.prototype.appendMessage = function(message, cb) {
  var self = this;

  this._createMessage(message, function(el) {
 ...
 * @param {function} cb A callback function
 */
View.prototype.prependMessage = function(message, cb) {
  var self = this;
 ...
 *
 */
View.prototype._createMessage = function(message, cb) {
 ...
 *
 */
View.prototype._renderText = function(textEl, text, cb) {
